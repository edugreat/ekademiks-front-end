...
import { AssessmentComponent } from '../assessment/assessment/assessment.list.component';
...
const routes:Routes = [
  ...
  {path:'assessment-panel/:subject', component: AssessmentExpansionPanelComponent}
]
